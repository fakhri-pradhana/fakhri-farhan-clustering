...
LANGKAH 3 :
MSA (measure of sampling adequacy) is a measure for exclusion of variables. 
If MSA < 0.5 the variable should be dropped.
Variables with MSA > 0.6 are suitable, variables with MSA > 0.8 very well suited for factor analysis.
The result tells us to drop "On.Target","Off.Target","Blocked", "Offsides", "Distance.Covered.Kms", "Yellow.Red", "Red", "first_goal" variables
```{r}
